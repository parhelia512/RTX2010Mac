...
resourcestring
  ...
  SPickerDone   = '完成';
  SEditorDone   = '完成';
  SListPickerIsNotFound = 'This version of Android doesn''t have an implementation of list pickers';
  ...
  SWrongParameter = '|%| parameter can not be nil';
  ...
  SPresentationProxyClassIsNil = 'AControlClass is nil. Factory can not register presentation with nil control class.';
